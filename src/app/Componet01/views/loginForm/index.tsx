...
const SignInForm = () => {
  let { signUpViaGoogle, userData, signInUser, loading, errorsOfFirebase } = useContext(ContextCart)
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
      ...
      <div className="max-w-md w-full bg-gra-100 p-8 shadow-lg border-t-8 rounded-xl border-gray-700">
        ...
        <div className="flex flex-col gap-y-2 items-center justify-center py-3">
            <button
          ...
          <div className="flex items-center justify-between space-x-2">
                  <Link className='text-blue-400 text-sm' href={"/singUp"}>Not have an account?</Link>
                    <button
