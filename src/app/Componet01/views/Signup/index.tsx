...
const SignupFormComp: React.FC = () => {
  let {errorsOfFirebase, signUpUser,signUpViaGoogle, loading, emailVerificationCode, userData } = useContext(ContextCart)
  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen">
            <div className="bg-slate-100 shadow-2xl border-t-8 border-blue-700 rounded px-4 md:px-8 pt-6 pb-8">
                <Toaster/>
                ...
                <div className="flex items-center justify-center py-3">
                    <button className="border flex gap-2 items-center justify-center bg-purple-100 hover:bg-purple-200 text-gray-700 font-semibold py-2 px-6 rounded focus:outline-none focus:shadow-outline" type="button" onClick={handleSignupWithGoogle}>
                ...
                <div className="flex items-center justify-between space-x-2">
                  <Link className='text-blue-400 text-sm' href={"/login"}>Already have an account?</Link>
                    <button
                        className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 px-2 md:px-5 rounded focus:outline-none focus:shadow-outline"
                        disabled={loading}
                        type="button"
                ...
                { userData && (
                    <div className='mt-4 flex flex-col justify-center items-center'>
                        ...
                        <button className="bg-purple-500 hover:bg-purple-700 text-white font-bold py-2 md:px-5 rounded focus:outline-none focus:shadow-outline" onClick={emailVerificationCode}>
                            Send
                        </button>
                    </div>
                )}
